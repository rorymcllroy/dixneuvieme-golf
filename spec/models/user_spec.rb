...
RSpec.describe User, type: :model do
  ...
  #     bad_event = Event.create(FactoryBot.build(:user, first_name: nil))
  #     expect(bad_event).not_to be_valid
  #     expect(bad_event.errors.include?(:first_name)).to eq(true)
  #   end

  #   it 'is not valid without last_name' do
  #     bad_event = Event.create(FactoryBot.build(:user, last_name: nil))
  #     expect(bad_event).not_to be_valid
  ...
  #     bad_event = Event.create(FactoryBot.build(:user, golf_level: nil))
  #     expect(bad_event).not_to be_valid
