class CarsharingsController < ApplicationController
  ...
  def create
    @carsharing = Carsharing.new(driver_id: params[:driver_id], date: params[:start_date], places: params[:place], description: params[:description], price: params[:price], golf_id: params[:golf_id])
